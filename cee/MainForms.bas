...
Sub MainRoutine()
    ...
    ' Step 3: Ask the user if they want to duplicate a table
    msgResponse = MsgBox("Do you want to duplicate a table?", vbYesNo + vbQuestion, "Duplicate Table")

    If msgResponse = vbYes Then
        DuplicateOperationTable
    End If
